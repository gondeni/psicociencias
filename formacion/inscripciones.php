    ...
    <section class="container g-pt-50 g-pb-40">
      <div class="row justify-content-between">
        <div class="col-lg-12 g-mb-20">
          ...
          <ul>
            ...
            <form action="enviar_inscripcion.php" method="POST" name="form" id="form" enctype="multipart/form-data">

              <!-- inicio corte 1 -->
              <div class="row corte" id="corte_1">
                <div class="col-md-12">
                  ...
                  <div class="card g-brd-primary rounded-0  g-mb-20">
                    ...
                    <div class="card-block">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-9">
                          <div class="form-group">
                            <label for="f_titulo">Adjuntar t&iacute;tulo*</label>
                ...
                <!-- fin corte 1 -->
                <div class="row corte" id="corte_2">
                  <div class="col-md-12">
                    <div class="card g-brd-primary rounded-0  g-mb-20">
                      ...
                      <div class="card-block">
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <div class="radio">
                              <label>
                                <input type="radio" name="pago" id="pagoP" value="P" onchange="datosDomiciliacion(this.value);">
                            ...
                            <div class="radio">
                              <label>
                                <input type="radio" name="pago" id="pagoY" value="E2" onchange="datosDomiciliacion(this.value);">
                            ...
                            <div class="radio">
                              <label>
                                <input type="radio" name="pago" id="pagoZ" value="P3" onchange="datosDomiciliacion(this.value);">
                            ...
                            <div class="radio">
                              <label>
                                <input type="radio" name="pago" id="pagoJ" value="E3" onchange="datosDomiciliacion(this.value);">
                ...
                <!-- fin corte 2 -->
                <div class="row corte" id="corte_3">
                  <div class="col-md-12">
                    <div class="card g-brd-primary rounded-0  g-mb-20">
                      ...
                      <div class="card-block">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <label>
                              <input type="checkbox" class="casilla_comprobable" name="fs" id="fs">
              ...
              <div class="row" id="botones_form" style="margin-top:-10px;">
                <div class="col-md-12">
                  <button class="btn previous pull-left" id="anterior" onclick="anterior(this)">&laquo; Anterior</button>
                  <button class="btn next pull-right" id="siguiente" onclick="siguiente(this)"> Siguiente &raquo;</button>
                </div>
              </div>
              <br/>
              <div>
      ...
      function siguiente(e){
        ...
        switch (tab) {
          ...
          if(comprobar_paso_1() == true){
            // $("#corte_1").fadeOut(1000);
            $("#corte_1").hide();
            $("#corte_2").fadeIn(1000);
            tab++;
          }
