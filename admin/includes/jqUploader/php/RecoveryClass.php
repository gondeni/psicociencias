	...
	class RecoveryClass {
		...
		public function saveFiles($ruta = '') {
			...
			foreach ($this->matrizDeArchivos as $keyArchivo=>$archivo){
				...
				// Inicio de campos personalizados CH
				$consulta .= $this->tablaDeArchivos["campoDeEstadoDeImagen"].", ";
				$consulta .= $this->tablaDeArchivos["campoDeFechaDeCreacion"].", ";
				$consulta .= $this->tablaDeArchivos["campoDeUsuarioDeCreacion"];
				// Fin de campos personalizados de CH
				$consulta .= ") VALUES (";
				...
				$consulta .= "'A', ";
				$consulta .= "'".date("Y-m-d")."', ";
				$consulta .= "'".$_SESSION["id_de_usuario"]."'";
				// Fin de campos personalizados de CH
				$consulta .= ");";
				try {
