	...
	$.fn.jqUploader = function (opcionesRecibidas) {
		...
		this.each(function(){ /* Empieza el procesado del objeto al que se asocia el plugin. */
			...
			*******************************************************************************************************************************************/
			...
			var zonaDeLogo = $('<span id="zonaDeLogo">' + '</span>');
			zonaDeLogo.css({
				'position': 'relative', 
				'top': '10px', 
				'padding': '0', 
			...
			*******************************************************************************************************************************************/
			$.fn.renderizarListaDeArchivos = function(archivoCargado) {
				...
				cadenaDeFicheroParaMostrar += '<div id="contenedor_' + archivoCargado['elements_id'] + '" style="position:relative; border:1px solid #666; ';
				//cadenaDeFicheroParaMostrar += 'border-radius: 0px; -moz-border-radius: 10px; -webkit-border-radius: 10px; ';
				cadenaDeFicheroParaMostrar += 'padding:6px; margin:4px auto; width:98%; min-height:112px; display:flex; ';
				...
				cadenaDeFicheroParaMostrar += 'color: #333; font-size: 2em; cursor:pointer;" id="borrar_' + archivoCargado['elements_id'] + '"></span>';
