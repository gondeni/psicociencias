          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Eliminar secci&oacute;n de la web</h3>
              </div>
            </div>
			...
			$consulta .= "WHERE id_de_padre=:idDeSeccion;";
			...
			$numeroDeSeccionesHijas = count($matrizDeSecciones);
		    
			if ($numeroDeSeccionesHijas == 0) {
				$consulta = "DELETE FROM maestro_de_secciones ";
				...
				$resultado = "<h2>La secci&oacute;n no puede ser borrada ya que tiene subsecciones asociadas.</h2>";
				$resultado .= "Primero, debes eliminar o asociar dichas subsecciones a otra secci&oacute;n.</h2>";
			}
		    ?>		    
