          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Editar secci&oacute;n de la web</h3>
              </div>
            </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div class="item form-group">
				    ...
				    <div class="col-md-6 col-sm-6 col-xs-12">
				       <input value="<?php echo $matriz["nombre_de_seccion"]; ?>" id="nombre_de_seccion" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="nombre_de_seccion" required="required" type="text">
				    </div>
				</div>
				<div class="item form-group">
				...
				<div class="item form-group">
					...
					<textarea name="cuerpo_de_seccion" id="cuerpo_de_seccion" class="form-control col-md-7 col-xs-12"><?php echo $matriz["cuerpo_de_seccion"]; ?></textarea>
					    <script>
				...
				<div class="item form-group">
				    ...
				    <div class="col-md-8 col-sm-6 col-xs-12">
					<textarea name="cuerpo_de_seccion_2" id="cuerpo_de_seccion_2" class="form-control col-md-7 col-xs-12"><?php echo $matriz["cuerpo_de_seccion_2"]; ?></textarea>
					    <script>
				...
				<div class="item form-group">
				    ...
				    <div class="col-md-8 col-sm-6 col-xs-12">
					<textarea name="cuerpo_de_seccion_3" id="cuerpo_de_seccion_3" class="form-control col-md-7 col-xs-12"><?php echo $matriz["cuerpo_de_seccion_3"]; ?></textarea>
					    <script>
				...
				<div class="item form-group">
				    ...
				    <div class="col-md-6 col-sm-6 col-xs-12">
				       <input value="<?php echo $matriz["keywords_de_seccion"]; ?>" id="keywords_de_seccion" class="form-control col-md-7 col-xs-12" name="keywords_de_seccion" type="text">
				    </div>
				</div>
