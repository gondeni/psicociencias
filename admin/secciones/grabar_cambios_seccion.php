    ...
    <div class="container body">
      <div class="main_container">
		...
		<?php
			...
			$consulta = "UPDATE maestro_de_secciones ";
			$consulta .= "SET nombre_de_seccion=:nombreDeSeccion, id_de_padre=:idDePadre, ";
			$consulta .= "cuerpo_de_seccion=:cuerpoDeSeccion, cuerpo_de_seccion_2=:cuerpoDeSeccion2, cuerpo_de_seccion_3=:cuerpoDeSeccion3, ";
			$consulta .= "estado_de_seccion=:estadoDeSeccion, keywords_de_seccion=:keywordsDeSeccion ";
			...
			$hacerConsulta->bindParam(":cuerpoDeSeccion", $cuerpo_de_seccion); 
			$hacerConsulta->bindParam(":cuerpoDeSeccion2", $cuerpo_de_seccion_2); 
			$hacerConsulta->bindParam(":cuerpoDeSeccion3", $cuerpo_de_seccion_3); 
			$hacerConsulta->bindParam(":estadoDeSeccion", $estado_de_seccion); 
			$hacerConsulta->bindParam(":keywordsDeSeccion", $keywords_de_seccion); 
