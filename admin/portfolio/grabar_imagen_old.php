<?php
	...
	$galeriaPropietaria = "maestro_de_portfolio";
	...
	// Ahora se genera la consulta para grabar las fotos del trabajo.
		...
		$hacerConsulta->bindParam(":idDeArticulo", $id_de_trabajo); 
