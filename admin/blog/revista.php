<?php
    ...
    $consulta = "SELECT id_de_noticia, id_de_seccion, boletin_de_noticia, titulo_de_noticia, estado_de_noticia, ";
    $consulta .= "destacado_de_noticia, portada_de_noticia, usuario_de_creacion ";
    $consulta .= "FROM maestro_de_noticias ";
    $consulta .= "WHERE boletin_de_noticia != 0 ";
    $consulta .= "ORDER BY boletin_de_noticia DESC;";
    $hacerConsulta = $conexion->prepare($consulta); // Se crea un objeto PDOStatement.
    $hacerConsulta->bindValue(":noticias", 0);
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Gesti&oacute;n de la Revista</h3>
                ...
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <table id="secciones" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th width="20%">Volumen</th>
                          <th width="35%">T&iacute;tulo del post</th>
                          <th width="15%">Secci&oacute;n</th>
                      ...
                      <?php
                        foreach($matrizDeNoticias as $noticia) {
                          ...
                          $consulta = "SELECT tituloDeBoletin ";
                          $consulta .= "FROM boletines ";
                          $consulta .= "WHERE idDeBoletines = :idDeBoletines;"; 
                          $hacerConsulta = $conexion->prepare($consulta); // Se crea un objeto PDOStatement.
                          $hacerConsulta->bindParam(":idDeBoletines", $noticia["boletin_de_noticia"]); // Se asigna una variable para la consulta.
                          $hacerConsulta->execute(); // Se ejecuta la consulta.
                          $boletin = $hacerConsulta->fetch(PDO::FETCH_ASSOC); // Se recuperan los resultados.
                          $hacerConsulta->closeCursor(); // Se libera el recurso.
                          ...
                          $hacerConsulta->execute(); // Se ejecuta la consulta.
                          $seccion = $hacerConsulta->fetch(PDO::FETCH_ASSOC); // Se recuperan los resultados.
                          $hacerConsulta->closeCursor(); // Se libera el recurso.
                          
                          echo "<tr>";
                          
                          echo "<td>".$boletin["tituloDeBoletin"]."</td>";
                          
                          echo "<td>".$noticia["titulo_de_noticia"]."</td>";
                         
                          echo "<td>";
                          echo $seccion["nombre_de_seccion"];
                          echo "</td>";
