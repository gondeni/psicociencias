<?php
	...
	$galeriaPropietaria = "maestro_de_noticias";
	
	/* Se establece la página de retorno */
	$paginaDeRetorno = "editar_post.php";
	...
	// Ahora se genera la consulta para grabar las fotos del articulo.
		...
		$consulta .= ") VALUES (";
		$consulta .= ":idDeNoticia, :galeriaPropietaria, :nombreDeFoto, :miniDeFoto, :altDeImagen, :miniDeImagen, ";
