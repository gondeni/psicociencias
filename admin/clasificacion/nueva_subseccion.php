<?php
	...
	$consulta = "SELECT id_de_seccion, nombre_de_seccion, entidad_propietaria ";
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Nueva subsecci&oacute;n del cat&aacute;logo</h3>
              </div>
            </div>
                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form action="grabar_seccion.php" method="POST" name="form" class="form-horizontal form-label-left" novalidate>
                            ...
                            <span class="section">Datos de la subsecci&oacute;n del cat&aacute;logo</span>

                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Nombre de subsecci&oacute;n <span class="required">*</span></label>
							...
							<div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Subsecci&oacute;n padre<br/>(Si aplica)</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
									<select class="form-control" id="id_de_padre" name="id_de_padre">
										<option value="0">--</option>
										<?php
											foreach ($matrizDeSistema as $item) {
												echo "<optgroup label=\"".$item["nombres_para_mostrar"]."\">";
												foreach($matrizDeSecciones as $seccion) {
													if ($item["valor"] == $seccion["entidad_propietaria"]) {
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Estado de la subsecci&oacute;n </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
