<?php
    ...
    /* Se genera una matriz con las secciones correspondientes a esta estidad */
    $matrizDeSecciones = array();
    $consulta = "SELECT id_de_seccion, id_de_padre, nombre_de_seccion, estado_de_seccion, entidad_propietaria ";
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Gesti&oacute;n de las secciones</h3>
                 <a href="nueva_seccion.php" class="btn btn-primary">Nueva secci&oacute;n</a>
                 <a href="nueva_subseccion.php" class="btn btn-success">Nueva subsecci&oacute;n</a>
              </div>
            </div>
            ...
            <div class="row">
			  ...
			  <th>Entidad</th>
				...
				if ($seccion["entidad_propietaria"] == $item["valor"]) {
				    echo "<td>".$item["nombres_para_mostrar"]."</td>";
				} 
			    }
			    ...
			    echo "onClick=\"javascript:saltarABorrarSeccion('".$seccion["id_de_seccion"]."');\" />";
			    echo "</td>";
			    echo "</tr>";
                        }
                      ?>
