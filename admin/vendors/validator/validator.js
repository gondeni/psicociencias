...
var validator = (function($){
    ...
    */
    message = {
        invalid         : 'El dato no es v&aacute;lido',
        checked         : 'Debe ser marcado',
        empty           : 'No puede estar vacio',
        min             : 'El valor es muy corto',
        max             : 'El valor es muy largo',
        number_min      : 'El valor es muy bajo',
        number_max      : 'El valores muy alto',
        url             : 'URL no v&aacute;lida',
        number          : 'Debe ser un n&uacute;mero',
        email           : 'El email no es v&aacute;lida',
        email_repeat    : 'Los emails no coinciden',
        password_repeat : 'Los passwords no coinciden',
        repeat          : 'No coincide',
        complete        : 'El dato no es completo',
        select          : 'Por favor, selecciona una opci&oacute;n'
    };
