<?php
	...
	/* Solo se nmodificar� la imagen en caso de que se maruqe para borra o venga una nueva. */
	if ($_FILES["imagen_de_curso"]["size"] == 0 && !isset($_POST["borrar_imagen"])) { // Si no se recibe imagen ni se ha marcado su eliminaci�n
			$nombreDeImagen = $_POST["imagen_actual"];
		} elseif($_FILES["imagen_de_curso"]["size"] == 0 && $_POST["borrar_imagen"] == "on") { // Si no se recibe imagen pero si se marca su eliminaci�n
			$nombreDeImagen = "";
