    ...
    <div class="container body">
      <div class="main_container">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Nuevo usuario: grabaci&oacute;n</h3>
              </div>
            </div>
		...
		<?php
			...
			$resultado = "";
			$consulta = "INSERT INTO maestro_de_usuarios (";
			$consulta .= "nombre_de_usuario, apellidos_de_usuario, tipo_de_usuario, login_de_usuario, password_de_usuario, estado_de_usuario ";
			$consulta .= ") VALUES (";
			$consulta .= ":nombreDeUsuario, :apellidosDeUsuario, :tipoDeUsuario, :loginDeUsuario, :passDeUsuario, :estadoDeUsuario);";
